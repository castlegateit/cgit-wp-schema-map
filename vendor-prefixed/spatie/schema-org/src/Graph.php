...
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Exceptions\InvalidType;
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Exceptions\TypeAlreadyInGraph;
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Exceptions\TypeNotInGraph;
...
class Graph implements Type, ArrayAccess, JsonSerializable
{
     ...
     *
     * @see \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Schema
     *
     * @param string $method
