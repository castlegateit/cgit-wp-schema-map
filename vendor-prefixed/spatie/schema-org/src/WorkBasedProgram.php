...
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\EducationalOccupationalProgramContract;
...
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\WorkBasedProgramContract;
...
class WorkBasedProgram extends BaseType implements WorkBasedProgramContract, EducationalOccupationalProgramContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DayOfWeekContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DayOfWeekContract[] $dayOfWeek
     *
     * @return static
     *
     ...
     * program.
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\CourseContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\CourseContract[] $hasCourse
     *
     * @return static
     *
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DefinedTermContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DefinedTermContract[]|string|string[] $programType
     *
     * @return static
     *
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\MonetaryAmountDistributionContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\MonetaryAmountDistributionContract[] $salaryUponCompletion
     *
     * @return static
     *
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DurationContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DurationContract[] $termDuration
     *
     * @return static
     *
     ...
     * full-time.
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DurationContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DurationContract[] $timeToComplete
     *
     * @return static
     *
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\MonetaryAmountDistributionContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\MonetaryAmountDistributionContract[] $trainingSalary
     *
     * @return static
     *
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\StructuredValueContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\StructuredValueContract[]|int|int[] $typicalCreditsPerTerm
     *
     * @return static
     *
