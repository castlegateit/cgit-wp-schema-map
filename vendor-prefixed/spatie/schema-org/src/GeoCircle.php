...
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\GeoCircleContract;
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\GeoShapeContract;
...
class GeoCircle extends BaseType implements GeoCircleContract, GeoShapeContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\GeoCoordinatesContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\GeoCoordinatesContract[] $geoMidpoint
     *
     * @return static
     *
     ...
     *
     * @param \Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DistanceContract|\Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Contracts\DistanceContract[]|float|float[]|int|int[]|string|string[] $geoRadius
     *
     * @return static
     *
