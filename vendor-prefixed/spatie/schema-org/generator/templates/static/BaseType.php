...
use ReflectionClass;
use Castlegate\SchemaMap\Vendor\Spatie\SchemaOrg\Exceptions\InvalidProperty;
...
abstract class BaseType implements Type, ArrayAccess, JsonSerializable
{
    ...
    {
        return '<script type="application/ld+json"'.$this->nonceAttr().'>'.json_encode($this->toArray(), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG).'</script>';
    }
